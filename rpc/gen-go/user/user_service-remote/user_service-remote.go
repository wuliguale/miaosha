...
func Usage() {
  ...
  fmt.Fprintln(os.Stderr, "  UserStruct reg(string username, string nickname, string password)")
  fmt.Fprintln(os.Stderr, "  UserStruct login(string username, string password)")
  fmt.Fprintln(os.Stderr)
  os.Exit(0)
}
